            ...
            if (mess.user) {
                ...
                <>
                  <div key={index} className={styles.messageBoxChatRight}>
                    ...
                    <div style={{ flex: "0.1", padding: "0.5rem" }}>
                      ...
                      {
                        UserDetails.Image ? <img style={{ width: "30px", height: "30px", borderRadius: "50%" }} src={UserDetails.Image} alt="user"/> : <span className={styles.innerFontSpelling}>{UserDetails?.Name[0]?.toUpperCase()}{UserDetails?.Name[UserDetails?.Name.length - 1]?.toUpperCase()}</span>
                      }
              ...
              return (
                <div key={index} className={styles.messageBoxChatLeft}>
                  <div style={{ flex: "0.1", padding: "0.5rem" }}><img style={{ width: "30px", height: "30px", borderRadius: "50%" }} alt="ecomIcon" src="https://i.ibb.co/k5Nn1Yx/Whats-App-Image-2023-06-18-at-11-50-49-PM.jpg" /></div>
