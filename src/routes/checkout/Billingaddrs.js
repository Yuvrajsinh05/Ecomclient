...
import { Payment } from '../../requests/adminreq'

function Billingaddrs({amount}) {
    
   const [AmountTobPaid , setAmounttoPaid] = useState("")
   ...
   useEffect(()=>{
    ...
    const handleCheckout = async (value) => {
        ...
        const data = { amount: AmountTobPaid }
        ...
        var options = {
            ...
            amount: AmountTobPaid * 100, // Amount is in currency subunits. Default currency is INR. Hence, 50000 refers to 50000 paise
            currency: "INR",
            name: "Acme Corp",
