      ...
      <div className="container-fluid bg-dark mb-30">
        <div className="row px-xl-5">
          ...
          <div className="col-lg-3 d-none d-lg-block">
            <Link className="btn d-flex align-items-center justify-content-between bg-primary w-100" onClick={toggleDropdown} style={{ height: "65px", padding: "0 30px", cursor: "pointer" }}>
            ...
            <nav className="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
              ...
              <div className="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                ...
                <div className="navbar-nav ml-auto py-0 d-none d-lg-block">
                  <Link onClick={() => { navigate("/liked", { state: { LikedProductsIds: storedData } }) }} className="btn px-0">
                  ...
                  <Link onClick={() => { navigate("/shoppingcart") }} className="btn px-0 ml-3">
            ...
            <div className="dropdown-menu position-absolute rounded-0 border-0 m-0">
              {subcat?.SubType?.map((subT, index) => {
                return (
                  ...
                  } className="dropdown-item" key={index}>{subT?.Name}</Link>
                )
              })}
            </div>
          </div>
